...
export default class SequelizeEngineQuery extends EngineQuery {
  ...
  async set<M extends TModel, S extends AllOptionalModelFields<M> | undefined | null = undefined>(
    ...
    try {
      if (search) {
        await instance.update<Model<ModelFields<M>>>(
          data as UpdateValueType, {
            where: search as SearchType
          }
        );
        return true as S extends undefined | null ? AllRequiredModelFields<M> | undefined  : boolean;
      }
      ...
      return undefined as S extends undefined | null ? AllRequiredModelFields<M> | undefined : boolean;
    }
  }
