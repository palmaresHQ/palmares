...
const fileByCode = {
  [`databases.ts`]: 
`import {  define, fields, Model, ON_DELETE } from '@palmares/databases';
    ...
    <div className="flex flex-col bg-[#ffffff]">
      ...
      <div className="flex flex-col w-full items-center justify-center mt-12 mb-12">
        ...
        >
          ...
          <div className='top-4 right-0 h-6 w-full absolute bg-transparent border-l-[1px] border-r-[1px] border-[#ffffff]'/>
      ...
      <div className="flex flex-col w-full items-center justify-center mt-12 mb-12">
        <h1 className="text-5xl font-bold text-primary-600 text-center">All you need, 
          <span 
            ...
            <div className='flex flex-col w-36 h-[840px] from-tertiary-500 to-white bg-gradient-to-b p-2'>
              {Object.keys(fileByCode).map((code, index) => (
                <Fragment key={code}>
                  ...
                  {index === Object.keys(fileByCode).length - 1 ? null : <div className="h-[2px] w- bg-tertiary-300 mt-2 mb-2"></div>}
                </Fragment>
              ))}
            </div>
          }/>
