 ...
 * ```
 */
export default function domain<TModifierArguments = object, TModifiers extends readonly (abstract new (...args: any) => {
    modifiers: any;
})[] = [], TCommands extends DefaultCommandType = DefaultCommandType, TLoadFunction extends (settings: any) => void | Promise<void> | ((args: DomainReadyFunctionArgs<any, any>) => void | Promise<void>) | Promise<(args: DomainReadyFunctionArgs<any, any>) => void | Promise<void>> = (settings: unknown) => void | Promise<void> | ((args: DomainReadyFunctionArgs<unknown, any>) => void | Promise<void>) | Promise<(args: DomainReadyFunctionArgs<unknown, any>) => void | Promise<void>>, TReadyFunction extends (args: DomainReadyFunctionArgs<any, any>) => void | Promise<void> = (args: DomainReadyFunctionArgs<unknown, any>) => void | Promise<void>>(
/**
...
path: string, args: {
    ...
    new (): {
        ...
        path: string;
        isLoaded: boolean;
        modifiers: TModifierArguments;
        __isReady: boolean;
        __isClosed: boolean;
    };
    __instance: Domain<any>;
};
