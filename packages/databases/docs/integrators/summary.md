...
# Palmares/Databases > Integrators > Summary
...
- [Migrating (Optional)](https://github.com/palmaresHQ/palmares/blob/main/packages/databases/docs/integrators/getting-started/migrating.md)
- [Querying](https://github.com/palmaresHQ/palmares/blob/main/packages/databases/docs/integrators/getting-started/querying.md)

## Concepts and APIs of Palmares
