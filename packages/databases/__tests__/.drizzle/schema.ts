/** Automatically generated by @palmares/drizzle-engine on 2024-12-03T13:40:58.245Z */
...
export const Company = d.sqliteTable(
  'companies',
  {
    ...
    real: d.integer('real', { mode: 'boolean' }).generatedAlwaysAs(() => drzl.sql`uuid_generate_v4()`)
  },
  (table) => ({
