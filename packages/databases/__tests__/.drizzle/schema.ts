/** Automatically generated by @palmares/drizzle-engine on 2024-10-01T18:44:04.775Z */ 
...
export const User = d.sqliteTable('users', {
  ...
  company2Id: d.integer('company2_id', { mode: 'number' }).notNull().references((): d.AnySQLiteColumn => Company.id)
}, (table) => ({
...
export const CompanyRelations = drzl.relations(Company, (args) => ({
  ...
  usersOfCompany2: args.many(User)
}));
