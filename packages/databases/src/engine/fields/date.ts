 ...
 * implementation.
 * - `translate` - Used to translate the DateField to something that the database can understand.
...
export function adapterDateFieldParser<
  ...
  TInputParserFunction extends NonNullable<AdapterDateFieldParser>['inputParser'],
  TOutputParserFunction extends NonNullable<AdapterDateFieldParser>['outputParser']
>(args: {
  /**
   * @description
  ...
  return CustomAdapterDateFieldParser as typeof AdapterDateFieldParser & {
    new (): AdapterDateFieldParser & {
      translate: TTranslateFunction;
      inputParser: TInputParserFunction;
      outputParser: TOutputParserFunction;
    };
