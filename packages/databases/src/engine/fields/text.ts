 ...
 *
 * This will be used to parse the fields that are going to be used in the model in the database, we call this class just for the `TextField`
 ...
 * - `translate` - Used to translate the TextField to something that the database can understand.
 ...
 */
export function adapterTextFieldParser<
  TTranslateFunction extends AdapterTextFieldParser['translate'],
  TInputParserFunction extends Required<AdapterTextFieldParser>['inputParser'],
  TOutputParserFunction extends Required<AdapterTextFieldParser>['outputParser'],
>(args: {
  /**
   * @description
  ...
  return CustomAdapterTextFieldParser as typeof AdapterTextFieldParser & {
    new (): AdapterTextFieldParser & {
      translate: TTranslateFunction;
      inputParser: TInputParserFunction;
      outputParser: TOutputParserFunction;
    };
