...
> extends CharField<F, D, U, N, AG extends true ? true : A, CA> {
  ...
  constructor(params: UUIDFieldParamsType<F, D, U, N, A, CA, AG> = {}) {
    super({
      maxLength: 36,
      isAuto: (typeof params.autoGenerate === 'boolean' ? params.autoGenerate : false) as AG extends true ? true : A,
      ...params,
    });
    this.autoGenerate = typeof params.autoGenerate === 'boolean' ? params.autoGenerate : (false as AG);
  }
  ...
  static new<
    ...
    CA = any,
    AG extends boolean = false
  >(this: I, params: UUIDFieldParamsType<InstanceType<I>, D, U, N, A, CA, AG> = {}) {
